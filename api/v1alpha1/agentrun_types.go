...
// --- AgentRun spec and status ---

// AgentRunSpec defines the immutable configuration for a run.
type AgentRunSpec struct {
	// agentRef is the name of the InfraAgent that owns this run.
	// +required
	AgentRef string `json:"agentRef"`

	// environmentRef is the name of the AgentEnvironment used.
	// +required
