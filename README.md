...
📖 **Automation packs schema:** [docs/automation-packs.md](docs/automation-packs.md)
...
| Automation packs Stage 3.8.2 (declarative workflow schema + dry-run planning + policy simulation) | ✅ |
...
- **Automation Packs**: `GET/POST /api/v1/automation-packs`, `GET /api/v1/automation-packs/{id}` (`?version=x.y.z` optional), `POST /api/v1/automation-packs/dry-run`
