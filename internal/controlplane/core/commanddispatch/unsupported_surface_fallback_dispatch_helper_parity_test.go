...
func TestDispatchUnsupportedCommandDispatchSurfaceFallback_ParityWithLegacyRepeatedCallShape(t *testing.T) {
	tests := []struct {
		name     string
		withHTTP bool
		withMCP  bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			legacyDispatchUnsupportedCommandDispatchSurfaceFallbackRepeatedCallShape(surface, legacyCapture.writer(tt.withHTTP, tt.withMCP))
...
func legacyDispatchUnsupportedCommandDispatchSurfaceFallbackRepeatedCallShape(surface ProjectionDispatchSurface, writer CommandProjectionDispatchWriter) {
