...
| Automation packs Stage 3.8.1 (declarative workflow schema + typed inputs + approval/outcome contracts) | ✅ |
...
- **Automation Packs**: `GET/POST /api/v1/automation-packs`, `GET /api/v1/automation-packs/{id}` (`?version=x.y.z` optional)
