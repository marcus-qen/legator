...
func TestRoutesAuthCoverage(t *testing.T) {
	...
	endpoints := []struct {
		...
		{http.MethodGet, "/api/v1/audit/export/bundle"},
		...
		{http.MethodGet, "/api/v1/notification-channels/some-id"},
		{http.MethodPut, "/api/v1/notification-channels/some-id"},
		{http.MethodDelete, "/api/v1/notification-channels/some-id"},
		{http.MethodPost, "/api/v1/notification-channels/some-id/test"},
